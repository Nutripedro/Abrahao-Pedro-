    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 mb-5 border-b border-slate-100 dark:border-slate-800 gap-3">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold bg-sky-50 dark:bg-sky-950/60 text-sky-700 dark:text-sky-300 border border-sky-200 dark:border-sky-800">
      ...
      {/* Visual Selector Cards: 4 Selectable Clinical Protocols */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 mb-5" role="radiogroup" aria-label="Seletor visual de protocolos antropométricos">
        {protocolsData.map((item) => {
          ...
          return (
            <button
              ...
              className={`p-4 rounded-2xl border text-left transition-all cursor-pointer relative flex flex-col justify-between group focus:outline-none focus:ring-2 focus:ring-sky-500 ${
                isSelected
